...
#Region ### START GUI section ### Form=
   ...
   $Form1 = GUICreate("Procedure Generator v1.00.27", 329, 460, -1, -1)
   ...
   ;CREATE GUI NOTIFICATION PLACE
	  ...
	  $Status = GUICtrlCreateLabel("Standby", 250, 220, 80, 17)
	  ;Button clear notif
...
Func Notification ($sNoti, $sMode) ;Mode = "Normal", "Replace Previous"
   ...
   If StringLen (GUICtrlRead ($Commu_Ctrl)) > 2000 Then Notification_Clear ()
