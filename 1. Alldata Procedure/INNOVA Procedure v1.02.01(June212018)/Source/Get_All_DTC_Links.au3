...
Func Scan_DTCs ()
   ...
   If StringInStr ($sTxt_Title, "ALLDATA Repair - Vehicle Information - ") <> 0 Then
	  ...
	  Else
		 ...
		 Next
	  If $sResult_Open <> "No Link Found" Then Notification ("DONE" & @CRLF & "Please CHECK!", "Normal")
	  EndIf
   ...
   If StringInStr ($sTxt_Title, "ALLDATA Repair - Vehicle Information - ") <> 0 Then
	  ...
	  Local $iOrder = 0
		 ...
		 For $i2 = 1 To $aChildren_Item_1[0]
			If $aChildren_Item_1[$i2] = "A L L Diagnostic Trouble Codes ( DTC )" Then
			   ...
			   For $i3 = 1 To $aChildren_Item_2 [0]
				  If $aChildren_Item_2[$i3] = "Information for A L L Diagnostic Trouble Codes ( DTC )" Then
					 ...
					 For $i4 = 1 To $aChildren_Item_3 [0]
						If $aChildren_Item_3[$i4] = "Testing and Inspection" Then
						   ...
						   For $i5 = 1 To $aChildren_Item_4 [0]
							  If $aChildren_Item_4[$i5] = "P Code Charts" Then
								 ;Click "P Code Charts"
