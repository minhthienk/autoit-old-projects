...
;~ 		 MsgBox ($MB_TOPMOST, "CRASH", "CRASH!" & @CRLF & "Press OK to Restart" & @CRLF & "or the App will automatically be restarted after 5 seconds", 5)
...
;~ 		 MsgBox ($MB_TOPMOST, "ERROR", "Unexpected ERROR!" & @CRLF & "Press OK to Restart" & @CRLF & "or the App will automatically be Restarted after 5 seconds", 5)
