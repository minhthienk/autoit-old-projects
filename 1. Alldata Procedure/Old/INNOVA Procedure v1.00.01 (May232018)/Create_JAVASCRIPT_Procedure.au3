...
;====================================================================================================================
Func Create_JAVASCRIPT_Procedure ($sFilePath_YMME, $sProcedure_Link)
...
;"javascript:navigateOnTree('/alldata/','621', '384', '5308182', '52950');")
;====================================================================================================================
;                  FUNCTION DISCRIPTION: CREATE OTHER PROCEDURE IN DTC FROM ALLDATA
;				   RETURN              : A STRING OF PROCEDURE PATH
;====================================================================================================================
Func Get_Procedure_Links_In_JAVASCRIPT ($sJavascript)
   ...
   Local $oIE = _IECreate ($sProcedure_Mother_Link)
   ;------------------------------------------------------------------------------------------------------------------
