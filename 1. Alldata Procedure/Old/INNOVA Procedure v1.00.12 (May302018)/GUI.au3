...
Global $bDeclaration_Flag = False
...
#Region ### START GUI section ### Form=
   ...
   $Button_Get_All_DTC = GUICtrlCreateButton("Get All DTC", 130, 160, 75, 25)
   GUICtrlSetOnEvent($Button_Get_All_DTC, "Get_All_DTC_Links")
