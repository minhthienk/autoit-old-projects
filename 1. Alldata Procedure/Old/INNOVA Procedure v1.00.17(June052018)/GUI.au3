...
Func Autoit_Exit ()
   ;Close_All_IE()
_ClipBoard_SetData (GUICtrlRead ($Commu_Ctrl))
   Exit
EndFunc
...
#Region ### START GUI section ### Form=
   ...
   GUICtrlCreateTab(10, 10, 309, 120)
	  ...
	  GUICtrlCreateTabItem("Permission")
		 ...
		 GUICtrlCreateLabel("To prevent the matter of using the app for personal purposes. You must enter a VALID KEY obtained from Thuan Huynh. Each valid key shall be exist for 6 hours", 32, 40, 260, 50)
		 ;-------------------------------------------
...
Func KeySubmit ()
   Local $sLink_Key
   $oIE = IECreate_Check_Error($sLink_Key, 0, 0, 1, 0)
...
;====================================================================================================================
;                  FUNCTION DESCRIPTION: WAIT FOR VALID KEY
;				   INPUT               :
;                  OUTPUT              :
;====================================================================================================================
...
;====================================================================================================================
;                  FUNCTION DESCRIPTION: WAIT FOR BUTTON PRESSED
;				   INPUT               :
;                  OUTPUT              :
;====================================================================================================================
While 1
