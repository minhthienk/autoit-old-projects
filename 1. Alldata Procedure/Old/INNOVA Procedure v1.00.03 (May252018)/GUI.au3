...
#Region ### START Koda GUI section ### Form=
   ...
   GUICtrlSetOnEvent($Button_Begin, "Check_Initial_Input")
...
Func Check_Initial_Input ()
   ...
   Local $bLink_Flag = 0
   Local $sNoti_Link = ""
   If StringLeft ($Input_Link_Val, 26) <> "http://repair.alldata.com/" And StringLeft ($Input_Link_Val, 26) <> "https://repair.alldata.com"  Then
   ...
   If ($bSub_Flag = 1) And ($bLink_Flag = 1) Then
	  ...
	  If Main_function ($Input_Link_Val) = "The link is invalid" Then
