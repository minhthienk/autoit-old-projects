...
#Region ### START Koda GUI section ### Form=
   ...
   $Form1 = GUICreate("Prepair Procedure Generator", 329, 270, 352, 197)
   ...
   $Combo_Subscription = GUICtrlCreateCombo("(License #)", 93, 90, 145, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
   GUICtrlSetData(-1, "# 1|# 2|# 3|# 4|# 5")
   $Label2 = GUICtrlCreateLabel("Select License", 130, 68, 120, 17)
   ;-------------------------------------------
