...
Func DTC_Procedure_Alldata ($oIE, $sInsert_Path, $sSub_Name, $sMode)
   ...
   ;---------------------------------------------
   ;MAIN OR NOT MAIN
   If $sMode = "Not Main" Then $sTxt_Title = "PROCEDURE_" & $sTxt_Title
   ;------------------------------------------------------------------------------------------------------------------
   ...
   If $sMode = "Not Main" Then
	  ...
	  Local $sFilePath_Title       = @ScriptDir & "\INNOVA Prepair Procedures"      &"\"&$sYMME      &"\PROCEDURE"       &"\"& $sTxt_Title
   ...
   Return "../../PROCEDURE/" & $sTxt_Title & "/" & $sTxt_Title & ".html"
EndFunc
