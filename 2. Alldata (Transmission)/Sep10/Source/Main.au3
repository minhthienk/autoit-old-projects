...
Func Main ()
   ...
   ;----------------------------------------
   ;SELECT VEHICLE
   For $iYearCount = 2017 To 1996 Step -1
	  $aSelectData = YearVehicleSelectData($oIE, $iYearCount, 'Dodge')
	  For $iYMMECount = 0 To UBound($aSelectData, $UBOUND_ROWS) - 1
		 ;Show the Selected YMME
		 MsgBox ($MB_TOPMOST, 'YMME', $aSelectData[$iYMMECount][1] & ' - ' & $aSelectData[$iYMMECount][2] & ' - ' & $aSelectData[$iYMMECount][3] & ' - ' & $aSelectData[$iYMMECount][4], 2)
