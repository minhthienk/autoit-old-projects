...
Func YearBeginSelected ()
   ...
   ;Remove dupplicates
   $aYearEnd = _ArrayUnique ($aYearEnd, 0, 0, 1, $ARRAYUNIQUE_NOCOUNT)
   ;Sort from less to greater
   _ArraySort ($aYearEnd)
...
Func YearEndSelected ()
   ...
   ;Remove dupplicates
   $aMakeList = _ArrayUnique ($aMakeList, 0, 0, 1, $ARRAYUNIQUE_NOCOUNT)
   ;Sort from less to greater
...
Func MakeSelected ()
   ...
   ;Remove dupplicates
   $aModelList = _ArrayUnique ($aModelList, 0, 0, 1, $ARRAYUNIQUE_NOCOUNT)
   ;Sort from less to greater
